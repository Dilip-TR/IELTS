 ...
 */
class PractsubCategory extends REST_Controller {
    ...
    public function create_practsubcategory_post()
    {
       
            $input_data = json_decode(trim(file_get_contents('php://input')), true);
            $this->load->model('PractsubCategory_model');
            $test=$this->PractsubCategory_model-> new_practsubcategory($input_data);

 ...
 */
class Testvideo extends REST_Controller {
    ...
    public function create_test_post()
      {
              ...
              $this->load->model('Testvideo_model');
              $test=$this->Testvideo_model->new_test($input_data);
               try { 
                    if(empty($test)) {
      ...
      public function save_test_post()
      {
              $input_data = json_decode(trim(file_get_contents('php://input')), true);
              $this->load->model('Testvideo_model');
              $test1=$this->Testvideo_model->get_result_test_rows($input_data['useId'],$input_data['testId']);
              if(sizeof($test1)){
                 $test=$this->Testvideo_model->save_test($input_data,'update');
              }else{
                 $test=$this->Testvideo_model->save_test($input_data,'save');
       ...
       public function awa_update_test_post()
      {
              $input_data = json_decode(trim(file_get_contents('php://input')), true);
              $this->load->model('Testvideo_model');
            
              
                 $test=$this->Testvideo_model->review_awa($input_data,'save');
           ...
           public function resume_test_post()
      {
        $input_data = json_decode(trim(file_get_contents('php://input')), true);
              $this->load->model('Testvideo_model');
              $test=$this->Testvideo_model->resume_test($input_data);
               try { 
                    if(empty($test)) {
                         $finall=array(array("response"=> "success" , "mesg"=> "") ) ;
                         $this->set_response( $finall, REST_Controller::HTTP_OK); // OK (200) being the HTTP response code
      ...
      public function test_all_list_get()
      {
              $input_data = json_decode(trim(file_get_contents('php://input')), true);
              $this->load->model('Testvideo_model');
              $commission_one=$this->Testvideo_model->test_list() ;
              try { 
      ...
      public function aws_cmsque_list_get()
      
          {
                  $name=$this->uri->segment('4');
                  $this->load->model('Testvideo_model');
                  $commission_one=$this->Testvideo_model->awscmsque_list($name) ;
      ...
      public function aws_uique_list_get()
        {
            ...
            $test=$this->Testvideo_model->awsuique_list($userid);
      ...
      public function test_all_user_by_id_get()
      {
              ...
              $this->load->model('Testvideo_model');
              $commission_one=$this->Testvideo_model->test_list_userId($input_data) ;
              try { 
                  if(empty($commission_one)) {
                      $this->set_response([], REST_Controller::HTTP_OK);
                  }else{
      ...
      public function test_by_id_get()
      {
              ...
              $this->load->model('Testvideo_model');
              $commission_one=$this->Testvideo_model->test_by_id($id) ;
              try { 
                  if(empty($commission_one)) {
                      $this->set_response([], REST_Controller::HTTP_OK);
                  }else{
      ...
      public function reviewtest_id_get()
      {
              ...
              $this->load->model('Testvideo_model');
              $commission_one=$this->Testvideo_model->test_review_id($userid,$testid) ;
              try { 
                  if(empty($commission_one)) {
                      $this->set_response([], REST_Controller::HTTP_OK);
                  }else{

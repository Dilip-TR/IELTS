...
class Subcategory extends REST_Controller {
    ...
    public function create_subcategory_post()
    {
       
            $input_data = json_decode(trim(file_get_contents('php://input')), true);
            $this->load->model('Subcategory_model');
            $test=$this->Subcategory_model-> new_subcategory($input_data);
  ...
  public function subcategory_all_list_get()
      {
              $input_data = json_decode(trim(file_get_contents('php://input')), true);
              $this->load->model('Subcategory_model');
              $commission_one=$this->Subcategory_model->subcategory_list() ;

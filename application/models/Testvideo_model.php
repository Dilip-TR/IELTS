...
class Testvideo_model extends CI_Model {
       ...
       public function review_awa($data,$text)
         {       
                    ...
                    $sql="CALL `updateawareview`($useId,$testId,'$graphdata')" ;
                    $query = $this->db->query($sql,array($useId,$testId,$graphdata));
                   ...
                   // exit;
                    $fre=$this->get_result_test_rows($useId,$testId);
                     ...
                     if($text == 'update'){
                        ...
                        $query = $this->db->query($sql,array($useId,$testId,$trackid,$toalObj,$resultData,$testType,$awsstatus,$graphdata));
                     }else{
                        //Insert row
                         // //Call proccedures 
                        $sql="CALL `saveTest`(?,?,?,?,?,?,?,?)" ;
